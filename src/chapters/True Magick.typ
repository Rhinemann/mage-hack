...
On its own, Correspondence allows the magus to reach across distances, even to places they cannot see or touch. At Rank #spec_char.d6 or higher, they can grasp items and work with them from a distance. To manipulate other objects or beings in ways other than physical contact, however, that magus must combine Correspondence with another Sphere -- typically a Pattern Sphere (Forces, Life, or Matter).
...
Basic spatial understanding allows a magus to sense things in their immediate vicinity even if they cannot perceive them with their normal senses. Using that perception, they can estimate the distances between objects; intuitively find a direction (North, South, East, West); notice hidden objects or characters; and spot spatial instabilities -- warps, anomalies, wormholes, etc. -- especially the ones caused by other Correspondence Effects.
...
That magus can now extend their senses across intervening space, sensing things in other locations. Such extensions, however, leave minor ripples in space... the kind noticed by Rank #spec_char.d4 Correspondence. Fortunately, they can also thicken space to cover their tracks.

By adding Life or Matter to Rank #spec_char.d6 Correspondence, the magus can grasp small items or organisms (housecat-sized or smaller) and then pull them through tiny holes in space. This lets them snatch business cards, guns, rabbits, and such from another location, apparently pulling them out of nowhere.
...
Using the Co-location Effect, magus can also appear in several different places at once. To function, however, they must add Mind #spec_char.d4 to that Effect. Each self mirrors the original's actions unless they also add Life #spec_char.d6 to that Effect, granting independence to every self.
...
Distance and dimensions become child's play to a magus at this Rank. they can distort space; alter sizes and stretch or compress objects (Matter), bodies (Life), or forces (Forces); connect different Patterns to one another across intervening space; or even superimpose places or objects on top of one another (extremely vulgar). Combining this Rank with Life #spec_char.d8, the magus may also expand their senses to perceive many different places at once.
...
Unlocking basic perceptions of the elements, a Forces-savvy magus can sense the flow of forces in their environment. they can boost their perceptions into the infrared or ultraviolet spectrums, notice electrons, see in the dark, view X-rays, discern the flow of sound or radio waves, spot kinetic energies, and hear frequencies beyond the normal human range.
...
Combining this Rank with other Spheres, that magus could also make an object (Matter) or organism (Life) attract or repel forces. Thus, they could weave minor protection spells or force fields... or, conversely, turn that target into a magnet (perhaps literally) for the forces in question.
...
Basic Life knowledge allows a person to read the presence and health of nearby life forms. With such knowledge, the magus can discern a living being's age, sex, and overall health. By combining those perceptions with other Spheres, they can also sense distant organisms (Correspondence #spec_char.d6), guess their potential for sickness or misfortune (Entropy #spec_char.d4), perceive them through past or future states (Time #spec_char.d6), or read the streams of Quintessence that bind them to the universe (Prime #spec_char.d4).
...
Simple organisms -- viruses, mollusks, insects, plants, etc. -- become clay in the magus's hands. They learn to adjust their Patterns (giving a crab wings, for example), and heal or kill them. Although they cannot yet transmute them into other states of being, they can cause flowers to bloom or wither, help trees bear fruit, and so on. Focusing on his own Pattern, they can also heal themselves or perform small alterations (hair color, skin tone, height, weight, and so on) to his basic form.
...
At this Rank, the magus may enact radical changes on any complex organism -- people, dogs, horses, and so forth. They can uplift other species with new limbs, opposable thumbs, increased brain capacity, etc., so long as they do not change their intrinsic nature.
Working with his own Pattern, that magus can transform themselves into other life forms of similar size and mass; they could become a Great Dane, for example, but not a hummingbird. The new body might require an adjustment period before the mind and reflexes reflect the new form.
...
With advanced knowledge, the magus can transmute one substance into another, so long as they do not alter its essential shape, temperature, or basic state (gas, liquid, solid). Depending upon that magus's practice, they might reshape lead into gold through alchemy, wood into stone through a hyper petrification process, or water into wine (and, with Life #spec_char.d8, wine into blood) through a sacred miracle. Rare and/or complex materials are more difficult to fabricate than simple ones; it is easier to turn stone into iron, for example, than into gold.
...
The fearsome power of Black Suits and psychic assailants allows the magus to command another person's actions as well as their thoughts, alter their perceptions or mental state, and project his own mind from his physical form. At this Rank, a magus can change someone's memories, drive them crazy (or sane), overlay their aura with a desired impression, and set up posthypnotic suggestions and commands. In addition, by using internal rather than external powers, they can project their astral form.
...
A beginning study of Prime allows the magus to perceive and channel Quintessence from Nodes, Tass, Wonders, and magickal Effects. they may spot energetic ebbs and flows, can sense and at least try to read Resonance and Synergy signatures, and could absorb additional Quintessence into their personal Pattern as an asset.

When infusing their Quintessence into an object, that magus may also consecrate the object with their personal energy. When they shapeshift, steps sideways, or otherwise alters their Pattern's metaphysical nature, that consecrated object will then change with their. In the process, it also picks up their personal Resonance... which, because it both identifies them and becomes essentially connected to them, is not always a good thing.
...
The terrible power of draining Quintessence from objects or forces (though not yet from living things) can disintegrate those targets, consume them in Primal flames, or decay them almost instantly. Reversing that flow, the magus can create objects that cannot be broken, or bond organic and inorganic materials together to create cybernetic implants, nanotech, and other Wonders. At this stage, they are able to enchant items permanently and draw Quintessence from the energetic Wellsprings of exciting events. By infusing their personal Quintessence into a Periapt, the magus might use Matter #spec_char.d10 to create a Soulgem - a portable vessel that is filled with their own Resonance and energy.
...
A Prime Master can draw Quintessence from anywhere, at any time, and channel it into other vessels as well. A dark, vulgar aspect of that power allows them to obliterate a living being by consuming all of his life force, whereas the reverse of that power infuses them with life force so strong that they are essentially blessed. Combining that ability with Life #spec_char.d12, they may turn complex organisms into Soulflowers - living Periapts who become walking batteries of boosted Quintessence. Such Mastery also allows the magus to create Nodes in significant places, and to nullify Paradox.
...
At this Rank, the magus may also compel spirits to appear, bind them into Fetish objects, or tie them to certain spots or prisons. For obvious reasons, such bondage is risky, especially if the spirit is powerful. A brave or foolish Spirit magus can even turn themselves into a temporary Fetish, channeling a spirit entity into his mortal body; in such cases, they lose his ability to use true magick, but they may employ the capabilities of the spirit inside them. On the flipside, they can also exorcise a spirit that has possessed a mortal host. In all cases, the magus enters a series of resisted rolls against the spirit, pitting his Willpower against that spirit's own.
...
As one might expect, a magus who manipulates the Time Sphere tends to appear distant from the moment at hand. Although they might have excellent timing, their sense of the importance of past/present/future events seems to be a bit more... fluid than usual for a person living by the clock in today's world.
...
By itself, this Effect allows the magus to see in their present location only. By combining Past/Future Sight with other Spheres, however, they could read the probable past or future impressions of objects or places (Matter), living things (Life), and alternate locations (Correspondence). Entropy #spec_char.d6 even allows them to glimpse multiple futures and pick out the one most likely to occur.

Reversing their powers of perception, that same magus can thicken the walls of time, which makes other Time Effects more difficult.
...
Speeding or slowing their relationship with time, the magus can now gain multiple actions, slow other characters or phenomena, or rewind small snatches of time. Or else slow another character, object, or even themselves.

By rewinding time, the magus can also move their immediate surroundings -- an Effect that pulls them out of the normal flow of time and allows them to retcon an action or two.
