...
Every character has an affinity Sphere they choose at character creation depending on their Tradition and natural talent. Whenever a character is casting an effect that involves their affinity Sphere they may spend a #spec_c.pp to double the Sphere die in a roll.
...
#block(breakable: false)[
  === Rating Spheres
  Spheres are ranked #spec_c.d4 to #spec_c.d12, representing the depth and intricacies of the mage's understanding of it, and therefore their power to control it.
]
...
#block(breakable: false)[
  ...
  That mage can now extend their senses across intervening space, sensing things in other locations. Such extensions, however, leave minor ripples in space... the kind noticed by Rank #spec_c.d4 Correspondence. Fortunately, they can also thicken space to cover their tracks.
]

By adding Life or Matter to Rank #spec_c.d6 Correspondence, the mage can grasp small items or organisms (housecat-sized or smaller) and then pull them through tiny holes in space. This lets them snatch business cards, guns, rabbits, and such from another location, apparently pulling them out of nowhere.

/ Correspondence Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Correspondence rating, add #spec_c.d6 and step up your effect die.
...
In addition, by combining Correspondence #spec_c.d8 with Forces, Life, or Matter, the mage can move things around from a distance, levitating, manipulating or teleporting them without physical contact.

/ Correspondence Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Correspondence rating.

#block(breakable: false)[
  ==== #spec_c.d10 Adept
  #quote[Rend Space/Ward/Co-locate Self]

  Creating larger holes in space, the mage can now open permanent gates between locations; isolate forces, spaces, objects, or people into their own tiny realms (by combining Correspondence #spec_c.d10 with Forces, Life, Mind, or Matter); and ward certain locations against specific Patterns (again, combining Forces, Life, Mind, or Matter with Correspondence) or Resonance energies (combining this Sphere with Prime #spec_c.d10). This warding effect can impede or even block the forbidden elements from crossing into, or out of, the protected space. (For extensive details about wards, see the sourcebook How Do You DO That?)
]

Using the Co-location Effect, mage can also appear in several different places at once. To function, however, they must add Mind #spec_c.d4 to that Effect. Each self mirrors the original's actions unless they also add Life #spec_c.d6 to that Effect, granting independence to every self.

/ Correspondence Command: Spend a #spec_c.pp to step up or double your Correspondence die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Correspondence rating.

#block(breakable: false)[
  ==== #spec_c.d12 Master
  #quote[Spatial Mutation/Co-Location]

  Distance and dimensions become child's play to a mage at this Rank. they can distort space; alter sizes and stretch or compress objects (Matter), bodies (Life), or forces (Forces); connect different Patterns to one another across intervening space; or even superimpose places or objects on top of one another (extremely vulgar). Combining this Rank with Life #spec_c.d8, the mage may also expand their senses to perceive many different places at once.
]

/ Correspondence Mastery: Take #spec_c.d6 appropriate stress or complication to double your Correspondence die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
/ Entropy Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Entropy rating.
...
/ Forces Command: Spend a #spec_c.pp to step up or double your Forces die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Forces rating.
...
/ Forces Mastery: Take #spec_c.d6 appropriate stress or complication to double your Forces die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
An organism that has been radically altered by Life magick (given new limbs or other characteristics that are not part of the creature's original Pattern) suffers Pattern bleeding: an inexorable Quintessence leak that inflicts #spec_c.d6 Hurt stress per day. Unless the caster uses Prime magick to refill that Pattern with fresh energy, or alters that Pattern permanently, the damage continues until the subject dies.
...
When combined with other Spheres, this basic level of understanding allows a mage to conjure base materials from energy or dissolve them into Quintessence (Prime #spec_c.d6); transmute matter into living tissue (Life #spec_c.d10 or higher); move an object through space (Correspondence #spec_c.d6 or higher) or time (Time #spec_c.d8 or higher); change ephemera into matter and matter into ephemera, or awaken the slumbering spirit within material objects (Spirit #spec_c.d8 or higher). In all cases, Matter #spec_c.d6 allows the mage to work with simple, homogenous, non-living substances. Complex mixtures of various elements usually require Rank #spec_c.d8 or higher, although simple combinations (like those found in bread, milk, paper, or gunpowder) are possible albeit more difficult.

/ Matter Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Matter rating, add #spec_c.d6 and step up your effect die.
...
By mixing Matter #spec_c.d8 with other Spheres, the mage can join inert matter with living tissue, disintegrate it into dust, shift objects with the power of thought, or otherwise perform amazing transformations upon apparently solid materials.

/ Matter Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Matter rating.
...
/ Matter Command: Spend a #spec_c.pp to step up or double your Matter die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Matter rating.
...
/ Matter Mastery: Take #spec_c.d6 appropriate stress or complication to double your Matter die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
/ Mind Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Mind rating, add #spec_c.d6 and step up your effect die.
...
/ Prime Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Prime rating, add #spec_c.d6 and step up your effect die.
...
/ Prime Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Prime rating.

#block(breakable: false)[
  ==== #spec_c.d10 Adept
  #quote[Expel or Infuse Energy/Tap Wellspring/Craft Tass & Permanent Wonders]

  The terrible power of draining Quintessence from objects or forces (though not yet from living things) can disintegrate those targets, consume them in Primal flames, or decay them almost instantly. Reversing that flow, the mage can create objects that cannot be broken, or bond organic and inorganic materials together to create cybernetic implants, nanotech, and other Wonders. At this stage, they are able to enchant items permanently and draw Quintessence from the energetic Wellsprings of exciting events. By infusing their personal Quintessence into a Periapt, the mage might use Matter #spec_c.d10 to create a Soulgem - a portable vessel that is filled with their own Resonance and energy.
]

/ Prime Command: Spend a #spec_c.pp to step up or double your Prime die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Prime rating.
...
By combining this Rank with Matter #spec_c.d8 and Prime #spec_c.d6, the mage can also create short-lived objects from ephemera; such creations must be constructed as if they were material things, and they fade away at the end of the Effect's duration.
...
/ Spirit Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Spirit rating.
...
/ Spirit Mastery: Take #spec_c.d6 appropriate stress or complication to double your Spirit die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
/ Time Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Time rating, add #spec_c.d6 and step up your effect die.
...
/ Time Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Time rating.
...
/ Time Command: Spend a #spec_c.pp to step up or double your Time die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Time rating.
...
/ Time Mastery: Take #spec_c.d6 appropriate stress or complication to double your Time die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
/ Data Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Data rating, add #spec_c.d6 and step up your effect die.
...
/ Data Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Data rating.
...
/ Data Command: Spend a #spec_c.pp to step up or double your Data die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Data rating.
...
/ Data Mastery: Take #spec_c.d6 appropriate stress or complication to double your Data die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
/ Dimensional Science Manipulation: On rolls to create an asset that can be produced by a #spec_c.d6 or lower Dimensional Science rating, add #spec_c.d6 and step up your effect die.
...
/ Dimensional Science Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Dimensional Science rating.
...
The specialist can also open large gateways into the subdimensions, although the people passing through those gates suffer the effects of the Anomaly unless the Gauntlet has already been lowered to 0 by a Dimension Science #spec_c.d6 Procedure.
...
/ Dimensional Science Command: Spend a #spec_c.pp to step up or double your Dimensional Science die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Dimensional Science rating.
...
/ Dimensional Science Mastery: Take #spec_c.d6 appropriate stress or complication to double your Dimensional Science die for for a roll. On a failure, step up the same stress or complication you took to activate.
...
As with Prime #spec_c.d4, the hypereconomist can also invest such energies and can utilize the Prime Force generated by Ventures as well as other, more mystical sources of Quintessence.
...
/ Primal Utility Control: Spend a #spec_c.pp to create a #spec_c.d8 asset that can be produced by a #spec_c.d8 or lower Primal Utility rating.
...
/ Primal Utility Command: Spend a #spec_c.pp to step up or double your Primal Utility die on a roll for an effect that can be accomplished by a #spec_c.d10 or lower Primal Utility rating.
...
/ Primal Utility Mastery: Take #spec_c.d6 appropriate stress or complication to double your Primal Utility die for for a roll. On a failure, step up the same stress or complication you took to activate.
