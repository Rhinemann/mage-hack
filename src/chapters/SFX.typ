...
*Area Effect:* When your action includes a Sphere, spend 1 #spec_char.pp to add a #spec_char.d6 and keep an additional effect die for each additional target past the first.
