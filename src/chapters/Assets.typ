...
#block(breakable: false)[
  == Signature Assets
  Some assets are so iconic and inherent to the characters that they don't need to create them or spend #spec_c.pp to keep them for longer. Signature assets belong to characters and act like any other trait.
]
