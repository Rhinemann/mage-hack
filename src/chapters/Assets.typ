...
- A player can create an asset greater than #spec_c.d6 and without spending a #spec_c.pp by making a test or a series of tests.
...
When creating a gear asset, you may add an SFX by stepping down your effect die or selecting an additional effect die of #spec_c.d6 or larger. If your effect die is higher than the asset cap, you can add SFX to step it down to match the asset cap.
...
If you roll a hitch in creating gear, the GM may activate it to add a limit to your gear, in which case you gain a #spec_c.pp and do not step up the effect die.

Gear can be used by one person for one scene. This allows you to make gear in one scene to be used in a later scene. You may spend #spec_c.pp s as normal to use gear for more than one scene or to open up the asset for everyone's use.

Gear assets can be retained for the next session by spending a #spec_c.pp. You may spend this #spec_c.pp at the end of the previous session or at the beginning of the current session.
...
/ Awkward: Gain a #spec_c.pp when you set aside the largest die in a pool that includes this asset. You may use that die as your effect die.

/ Comfy: When you use this asset to recover a complication, spend a #spec_c.pp to step up your effect die.

/ Conspicuous (Limit): Gain a #spec_c.pp when this asset attracts unwanted attention.

/ Cornucopia: Spend a #spec_c.pp when feeding friends and allies to add a #spec_c.d6 and keep an additional effect die for each person you are providing a Well Fed asset.
...
/ Subtle: When you roll to hide this asset or when you bring it out of hiding, spend a #spec_c.pp to double its rating.
...
/ Power Requirements (Limit): Gain a #spec_c.pp and shutdown the asset when this asset's power source runs out. Recover at scene end.

/ Single Use: Add an additional die to your total and eliminate this asset.

/ Shoddy: Attempts to shutdown this gear do not need an effect die larger than its rating; just beating the difficulty will do. When it is shutdown, gain a #spec_c.pp. Recover at scene end.

/ Spread Targeting: Step down your largest effect die to select an additional effect die.

/ Supercharged: Add a #spec_c.d6 to Peril to double this asset for a single roll.
...
/ Authoritative: When you lean on the authority indicated by this armor's insignia, add a #spec_c.d6 to Peril and double this asset.

/ Encumbering (Limit): When this armor's weight and construction interferes with your movement, give its die to your opposition to roll as a complication and gain a #spec_c.pp.

/ Eye Slits (Limit): When you don't see something important because of your armor's decreased visibility, gain a #spec_c.pp.

/ Ill-Fitting (Limit): At the end of any physical exertion in this armor, gain a #spec_c.pp and the complication Chafing #spec_c.d6.

/ Loud (Limit): When the noise of your armor draws unwanted attention to you, gain a #spec_c.pp.
...
/ Revealing: When you enter a fight in which this armor's design exposes your body to danger but makes you look good doing it, gain a #spec_c.pp. At the end of the fight, step up any Harmed stress or injury complication you took.

/ Shock Absorbent: Step down the effect die of any complications you suffer from blunt or crushing attacks.

/ Supple: When you move through tight spaces or employ acrobatics, spend a #spec_c.pp to double this asset.

/ Spikes: When physically attacked in melee combat, spend a #spec_c.pp to inflict the complication Gouged by Spikes #spec_c.d6 on the attacker. This complication cannot be stepped up by this SFX.

/ Turnblade: Spend a #spec_c.pp to rename a complication involving grievous puncture or laceration injuries to bruising or concussion.
...
/ Bonebreaker: Spend a #spec_c.pp to step up Harmed stress or an injury complication you inflict that involves broken bones.

/ This Supplies...: When you exploit your leverage, spend a #spec_c.pp to step up your effect die.
...
/ Intimidating: Double this asset's die when rolling to intimidate and gain or step up the complication Priority Target #spec_c.d6.

/ Keep At Bay: Gain a #spec_c.pp when you use your weapon to inflict a complication limiting a target's movement instead of injuring them.

/ Knockback: Spend a #spec_c.pp to apply an extra effect die, stepped up, to inflict the complication Knocked Back.
...
/ Offensive: When fighting offensively, spend a #spec_c.pp to step up your effect die.

/ Out of Ammo (Limit): gain a #spec_c.pp when this weapon runs out of ammunition. Step down the asset for any roll where you use it without ammunition.

/ Ornamental (Limit): When you use this weapon in an actual fight, gain a #spec_c.pp when you swap out its rating for a #spec_c.d4.
...
/ Detailing Tools: When you create an asset and your effect die is higher than the cap, earn a #spec_c.pp and step down your effect die.

/ Mass Production: When you use this tool to create an asset, use a second effect die to create a second asset for free.

/ Precision Instruments: When you are building or creating with this asset, spend a #spec_c.pp to prevent a hitch from being activated. You may spend multiple #spec_c.pp s for multiple hitches as long as you do not botch.

/ Straw to Gold: The quality of this tool makes up for inferior materials. Spend a #spec_c.pp to step up an asset you are consuming in a crafting roll.
...
/ Demanding (Limit): This weapon makes demands at awkward moments; when it does so, earn a #spec_c.pp and shutdown the asset. Restore via test or otherwise fulfilling the weapon's demand.

/ Electrified: Spend a #spec_c.pp to wreathe this weapon in electricity. On any subsequent attack roll, each metal target (or target wearing metal) adds a #spec_c.d6 to your attack pool and allows you to use an additional die as an effect die. Once this effect is used, the weapon's charge is grounded.

/ Flaming: Spend a #spec_c.pp to ignite this weapon. While ignited, step up its effect die for targets who can be burned. The weapon's die is added to any roll to detect you or attack you at range.
...
/ Loyal: Spend a #spec_c.pp to return the weapon to your hand. If you do this as part of an attack (their head just happened to be in the flight path) or to create an asset (it is pretty impressive), step up your effect die.
...
/ Seeking: Speak a target's name to the weapon and spend a #spec_c.pp to double the asset's die against them.

/ Singing (Limit): When this weapon decides to break out in song (it just does that) and gives away your position, embarasses you, or otherwise inconveniences you, gain a #spec_c.pp.

/ Spellslicer: Spend a #spec_c.pp to add to your roll a die that matches every die in the opposition's pool representing something magical.
...
/ Armor Piercing Rounds: When using armor piercing rounds, spend a #spec_c.pp to add a die to your pool of equal size to the opposition's die representing armor.

/ Black Powder (Limit): When your powder gets wet, earn a #spec_c.pp and shutdown this asset. Recover at end of scene.

/ Pray and Spray: Add a #spec_c.d6 to Peril to double this asset.

/ Recoil: Step up your effect die on this roll, then give it to your opposition to roll in their next action.

/ Roomsweeper: Spend a #spec_c.pp to add a #spec_c.d6 to your pool for every additional target in front of you. Keep an extra effect die for each target after you roll.

/ Scope: When you are able to aim without haste or interruption, step up your effect die.

/ Silencer: Spend a #spec_c.pp to add a #spec_c.d6 to your pool for every potential witness in earshot. Keep an extra effect die to inflict the complication Unaware on each target.

/ Special Ammo: When using special ammunition, spend a #spec_c.pp to step up your effect die.

/ Warped Aim: When shooting at range, gain a #spec_c.pp to step down this asset's die.
...
/ Interference (Limit): When this piece of gear interferes with other technology that you or an ally needs, add its rating to the opposition pool and gain a #spec_c.pp.

/ Jammed (Limit): Gain a #spec_c.pp when this asset stops working right as you need it. Shutdown the asset and restore it via test or opportunity.
...
/ Grapplehook: When you hook this asset onto an item, person, or bit of landscape, gain a #spec_c.pp. This asset is attached until you make a successful roll to close the distance or to detach.

/ Hello There: When you use this item to travel at surprising speed or in a surprising manner, spend a #spec_c.pp to join a scene in progress.

/ Maneuverable: When you use this item to create an asset for moving into an advantageous position, spend a #spec_c.pp to step up your effect die.

/ Poof: Spend a #spec_c.pp when you use this asset to escape. You immediately leave the scene and cannot be targetted; you give in to any contest you were in. You may spend another #spec_c.pp to describe your new location and re-enter the scene.

/ Sharkskin Gloves: Spend a #spec_c.pp to double this asset when climbing.

/ Ta Da: When you use this item to make an impressive entrance, gain a #spec_c.pp.

/ Vault: Spend a #spec_c.pp to double this item when using it to vault over or around obstacles.
...
/ Data Firehose (Limit): Gain a #spec_c.pp when you get distracted by the torrent of information this asset delivers to you.

/ Hard Ping: When you use this asset to find someone or something such that they will know you are looking, add a #spec_c.d6 to Peril and double this asset.
...
/ Passive Scanning: Spend a #spec_c.pp to reveal an exploitable detail that your passive methods have uncovered.
...
/ Tracker: Spend a #spec_c.pp to step up your effect die when inflicting the complication Being Tracked.
...
/ Bloodletter: When you make someone bleed, add a #spec_c.d6 to Peril to use an extra effect die to inflict a Bleeding complication. Activate later opportunities to step up the complication.
...
/ Entangling: Spend a #spec_c.pp to step up your effect die when inflicting an Entangled complication or similar.

/ LASERSWORD: Spend a #spec_c.pp to use this weapon to cut through any object. If that object is represented by a trait, double this asset in the test to shutdown that trait.

/ Monowire: Add a #spec_c.d6 to Peril to double this asset. On a hitch, you or an ally gain Hurt equal to the highest Peril die without removing that die from Peril.

/ Nonlinear: Use the curve or flexibility of this weapon to circumvent defenses and spend a #spec_c.pp to double this asset's die.
...
/ Whipcrack: On a successful attack, spend a #spec_c.pp to give everyone else in the scene Rattled #spec_c.d6.
...
/ Poison Injector: Add a #spec_c.d6 to Peril to use an extra effect die to inflict a Poisoned complication. Activate later opportunities to step up the complication.
...
/ Sticky (Limit): When this weapon gets stuck in a target, gain a #spec_c.pp and shutdown this asset. Recover with a test or opportunity.


#block(breakable: false)[
  === Finding Gear
  When adventurers search for useful items -- usually after a successful encounter -- they can make a basic roll to determine if they find something helpful that isn't secured or hidden away. A successful roll means they discover a useful item that can be used as an asset. By spending a #spec_c.pp, they can add this item to their character sheet for the remainder of the session (and potentially beyond).
]
...
The GM may also set an upper limit on the item's effectiveness to reflect the usefulness of what can be found. Often, it's easiest to establish a general cap for the entire session -- for instance, limiting any found item's rating to #spec_c.d8. Locations designed to store specific items might allow for a higher cap.

For difficulty, the GM can roll Peril, telling the player the target number they need to beat.

The player assembles a dice pool as usual. Scene distinctions related to the encounter can be applied here: if the distinction is helpful, it's rolled as a #spec_c.d8; if it's a hindrance, it's rolled as a #spec_c.d4 and gives the player a #spec_c.pp. For example, a Haunted Armory could be rolled as a #spec_c.d8 due to the availability of various weapons, or as a #spec_c.d4 if everything is damaged and neglected. The player chooses how the scene distinction applies.

If any dice roll a 1, it could trigger a trap or cause the player to encounter rot and decay. For example, a display case with the captain's armor might be trapped with poison darts, weapon racks could collapse due to dry rot, or cursed alchemical ingredients could harm the player. Give the player a #spec_c.pp when this happens, then either impose a #spec_c.d6 complication or add the rolled 1 to the doom pool.

If the player's roll beats the difficulty, they find what they're looking for and gain it as an asset, with a rating equal to the effect die or the cap, whichever is lower. This asset can be used for one scene -- either the current one or a future scene. To keep the asset for the entire session, the player can spend a #spec_c.pp. If, for example, a player searches for a sword but only rolls a #spec_c.d4 effect die, they might decide it's not worth keeping.

Players can trigger the Hinder SFX during a gear roll to gain a #spec_c.pp, then use that #spec_c.pp to keep the asset for the rest of the level.

If a player has plenty of #spec_c.pp s, they can spend one to keep an additional effect die, acquiring two assets instead -- for example, both a Forbidden Grimoire #spec_c.d8 and a Ceremonial Dagger #spec_c.d6. Keeping both items for the session would cost two additional #spec_c.pp s.
...
Larger and more numerous dice increase the chance of achieving a heroic success, which can enhance the effect die. Even if your dice pool only includes a few #spec_c.d10 s, a heroic success might lead to a #spec_c.d12 effect die.
...
#block(breakable: false)[
  #table(
    ...
    [#spec_c.d4], [0], [---],
    [#spec_c.d6], [1], [---],
    [#spec_c.d8], [2], [#spec_c.d6],
    [#spec_c.d10], [3], [#spec_c.d8],
    [#spec_c.d12], [4], [#spec_c.d10],
  )
]
...
Most of the time, craftspeople are happy to supply PCs with standard, unremarkable items at reasonable prices. Players can spend a #spec_c.pp to turn these into #spec_c.d6 assets or make a "shopping" roll to purchase assets based on their effect die, possibly limited by an asset cap. These options are for standard, "off-the-shelf" items that come without special effects (SFX). If players want something more unique, they'll need to commission a custom piece, which these rules cover.
...
The effect die from this financing roll determines the rating of the crafted asset. Special effects (SFX) can be added by reducing the effect die or by selecting additional effect dice larger than #spec_c.d4.
...
The effect die from this final roll determines the rating of the stolen asset. Players can add special effects (SFX) to the item by stepping down the effect die or adding other effect dice rated at #spec_c.d6 or higher. Alternatively, they may choose to apply one of the limits listed below to increase the effect die rating.
...
/ Hot Item (Limit): Gain a #spec_c.pp when this item's prior owners (or its prior prior owners) show up at the worst possible moment.
...
/ Surprise Requirements (Limit): When you discover this item requires something to operate, shutdown the asset and gain a #spec_c.pp. Recover via test.
