...
_*Aura of Faith:*_ When an ally within your reach takes #trait[Demoralised] from fear or doubt, either of you can spend a #pp to step down the stress the ally takes. If this steps it down below #d6, they
take no stress at all.

_*Auxiliary Operational Mode (Gear):*_ Step down the highest die in your pool to step up an effect die when someone is attempting to unweave or counterspell the magick enacted using your gadgets and
devices.
...
_*Blessed Orator:*_ When you roll to preach to a crowd, spend a #pp to add a #d6 to your pool for every audience member beyond the first. Assign an effect die to each listener as an asset for them or as
#trait[Demoralised].

_*Bottle Up Your Feelings:*_ Take a #trait[Emotionless #d6] complication to create a #trait[Bottled Emotions #d8] asset: a magical bottle holding your emotions. While you have it, take #trait[Emotionless
  #d6] at the start of each scene, but whenever you would take #trait[Demoralised] or #trait[Enraged], step up #trait[Emotionless] instead. You can end the asset voluntarily by drinking the bottle,
otherwise when the asset ends, the bottle explodes. If #trait[Emotionless] would step up past #d12, end the asset instead. When the bottle asset ends, any #trait[Emotionless] complication you have turns
into #trait[Demoralised].

_*Brace and Aim (Gear):*_ If you haven't moved yet during your turn, spend a #pp to give yourself a #d8 asset related to aiming with a ranged weapon. Remove this asset if you move more than two paces
during a single beat.

_*Building Momentum:*_ When you succeed on a roll to inflict stress or complication, spend a #pp to gain or step up the asset #trait[Momentum #d6]. If you fail any roll or make a recovery roll, eliminate
the asset.
...
_*Combat Veteran:*_ When your roll to inflict #trait[Damaged] or #trait[Demoralised] during a battle includes #trait[Soldier], step down the largest die in your pool to add #d8. If your roll succeeds,
...
_*Connections in Low Places:*_ Spend a #pp to reveal a personal connection --- shared childhood, marriage relation, worked the same crew, or the like --- to a person of little social standing, gaining a
#d8 asset related to that person.
...
_*Dimensional Magic:*_ Take #trait[Drained #d6] to step up #trait[Spirit] or #trait[Correspondence] when rolling to summon and control something from elsewhere, or to use teleportation or portals. If your
roll succeeds, step up your effect die.

_*Dimensional Vagabond:*_ When stepping sideways spend a #pp to double #trait[Spirit] in your pool.

_*Dirty Fighter:*_ Immediately before or after rolling against a foe, spend a #pp to stoop to dishonourable tactics and inflict a #d6 complication like #trait[Sand in Eyes] or #trait[Sucker Punch] on that
opponent.
...
_*Envenomed Weapon (Gear):*_ When you succeed on a roll to inflict #trait[Damaged] with a weapon while you have a poison-related asset, if your total is an even number, keep an additional effect die as a
complication against the same foe.

_*Erudite Researcher (Gear):*_ When you spend an hour or more with good sources (a library, a meticulous ledger, accurate maps, informed and cooperative experts, etc.) add #d6 and step up your effect die
on rolls to create research-based assets.

_*Evading:*_ When you roll to create an asset or recover stress, spend a #pp to keep and step up a second effect die as an asset for yourself related to avoiding physical harm. This asset immediately ends
if you roll to inflict stress or complications, but while you have it, if an SFX would allow someone to inflict stress on you by spending a #pp, you ignore that stress.
...
_*Focused Stillness (Gear):*_ If you haven't moved yet during your turn when you roll to use a ranged weapon that you're wielding with two hands, you can step up one asset in your pool and step up any
stress you inflict.

_*Glade Keeper:*_ When you take a complication while defending a wild or sacred place from encroachment or corruption, you can either step up that complication to earn a #pp or spend a #pp to immediately
step it down.
...
_*Hell on Wheels:*_ Double or on a roll to manoeuvre a vehicle or mount, or to outrun someone or avoid falling. If the roll succeeds, step up your effect die. Also, while you are mounted or in a vehicle,
if an SFX would allow someone to inflict stress on you by spending a #pp, you ignore that stress.
...
_*Maintaining Composure:*_ Spend a #pp or take #trait[Enthralled #d6] to step up #trait[Speaker] or #trait[Soldier] on a roll related to tenacity, resolve, staying calm, reassuring someone, or keeping
emotions in check.

_*Manipulative Instincts:*_ Spend a #pp or take #trait[Enthralled #d6] to step up #trait[Speaker] or #trait[Scoundrel] on a roll related to reading people, manipulating emotions, or influencing someone's
actions.
...
_*Network:*_ While in a populated settlement, spend a #pp to create #d8 asset in the form of a STC who provides free room and board for you and your allies. As long as you don't overstay your welcome or
cause trouble, the STC will even help hide your presence.
...
_*Outmanoeuvre:*_ When your roll to inflict #trait[Damaged] or #trait[Drained] while outdoors includes #trait[Scout], step down the largest die in your pool to add #d8. If your roll succeeds, step up your
effect die.
...
_*Paramedic Training:*_ Step up or double #trait[Scholar] in your dice pool when helping others recover #trait[Damaged]. You can also spend a #pp to step down your own or a nearby character's #trait
[Damaged].
...
_*Peacemaker:*_ If you have #trait[Damaged] inflicted by another character in the scene when you roll to de-escalate a conflict, double #trait[Speaker] in your dice pool. If the roll still fails, take
#trait[Demoralised #d6].
...
_*Pretty Good With a Staff (Gear):*_ When you attack with a hafted weapon, step up the smallest die in your pool. On a success, keep an extra effect die as a complication on the target related to
battlefield positioning.

_*Primeval Sense:*_ Spend a #pp to create a #d8 asset related to wilderness awareness. While you have this asset, you know if there are any unnatural or otherworldly creatures within a mile of you, and
can sense their general direction. If you're within a mile of a settlement, all you can sense is the settlement, and your asset is shut down.

_*Quell The Spirits:*_ When dealing and negotiating with spirits take #trait[Enthralled #d6] to reroll a die in your roll.

_*Quick Wits:*_ Spend a #pp or take #trait[Enthralled #d6] to step up #trait[Scholar], #trait[Scoundrel], or #trait[Scout] on a roll related to reflexes, reaction time, thinking fast, or puzzling out
enigmas.

_*Reassuring Comrade:*_ Step up or double #trait[Speaker] in your dice pool when helping others recover #trait[Demoralised]. You can also spend a #pp to step down your own or a nearby character's #trait
[Demoralised].
...
_*Storied History:*_ When interacting with spirits spend a #pp to introduce a details about the entity you're interacting with, whether it be past dealings, past connections, forgotten oath, etc
represented by a #d8 asset.
...
_*Take the Heat:*_ When an ally fails a roll to avoid #trait[Demoralised], or a complication, spend a #pp to let them reroll all their dice. If the roll still fails, take an [Exposed #d6] complication to
step down the stress or complication the ally takes.
...
_*Trust Me, I'm an Engineer:*_ When using magick spend a #pp to turn a vulgar effect into a coincidental one if you are being observed by uneducated Sleepers, then shut down this SFX. Activate an
...
_*Versatile Grip (Gear):*_ When you roll to use a weapon that can be wielded one-handed or two-handed, if you wield it with two hands, you can double your attribute. If you fail, step up the stress you
take from failing.
...
_*Vigilantism:*_ When you roll to inflict a complication or stress on someone you caught committing a serious crime, or whom you know to be part of criminal organization or unlawful conspiracy, add #d6
...
_*What's the Worst That Can Happen:*_ When you roll to create an asset for a desperate or dubious plan of action, explain to another character what the worst-case failure scenario looks like to step up
your largest die and step up your effect die. Add a die to the peril pool equal to your effect die.
