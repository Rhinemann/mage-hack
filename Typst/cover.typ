...
#let placeholder_im = rect(fill: gold.transparentize(40%), width: 80%, inset: 30pt)[
...
#let back_cover = {
  page(
    ...
    #show heading: it => {
      set text(font: ("XWGXSC+CortexSymbology", "Abbess"), fill: gold, size: 16pt)
      align(center)[#it]
    }
    #set text(font: ("XWGXSC+CortexSymbology", "Goudy Old Style"), fill: white, size: 10pt)
